...
* The key idea is learning how to automatically turn semi-structured data (input) into structured data (output). 
...
- Examples: HTML (Hypertext Markup Language) files (e.g., websites) and JSON (JavaScript Object Notation) files (e.g., APIs)
...
- The difference matters when your data size is large. Suppose the size of the Twitter data you downloaded is 10 G.B. R/RStudio might have a hard time dealing with this size of data. Then, how can you wrangle this size of data in a complex way in R?
