...
- Co-Instructor: [Jae Yeon Kim](https://jaeyk.github.io/) (jaeyeonkim@berkeley.edu)
- Co-Instructor: TO DO
...
part1_headings <- c(
  ...
  "Developing your own data tools") # Jae 

part2_headings <- c(
"Web scraping",
"PDF scraping",
"Social media scraping", # Jae:
"Supervised machine learning", # Jae:
"Unsupervised machine learning", # Jae: 
"Database, SQL, MongoDB, and Spark", # Jae: 
"Wrap-up",
"Final presentation")
