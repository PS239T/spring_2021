...
- In the third, students learn how to use functions to automate repeated things and develop their own data tools (e.g., R packages, Shniy apps). 
...
part1_headings <- c(
  ...
  "Managing data and code", # Jae: Command line + Git 
  "Tidy data and why it matters",
  "Wrangling data", 
  "Modeling and visualizing tidy data",
  "From for loop to functional programming", # Jae 
  "Developing your own data tools (e.g., R packages, Shiny apps") # Jae 

part2_headings <- c(
"Web scraping (HTML, CSS, JavaScript)",
"PDF scraping",
"Social media scraping (XML, JSON)", # Jae:
"Supervised machine learning", # Jae:
"Unsupervised machine learning", # Jae: 
"Database and SQL", # Jae: 
...
![](https://raw.githubusercontent.com/PS239T/spring_2021/main/_logistics/tweet_screenshot.png?token=AKSMUVJJIPLL7QJ4V22GHZS73E2XW)

Let's co-create a learning environment where everyone feels safe to ask (even very basic) questions without being intimidated.
